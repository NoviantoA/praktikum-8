        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="proses_insert_3.php" method="post">
                        <br>
                        ...
                        <br>
                        <button type="submit" name="Submit_3" class="btn btn-primary pull-right"><a
                                href="formulir-pesertadidik-4.php"></a> Selanjutnya</a>
                            <i class="fa fa-arrow-right" aria-hidden="true"></i>
                        </button>
                        <button type="" class="btn btn-primary pull-left"><a
                                href="formulir-pesertadidik-2.php">Kembali</a> <i class="fa fa-arrow-left"
                                aria-hidden="true"></i>
                        </button>
                    </form>
                </div>
